...
const Footer = () => {
    ...
    return (
        <footer className="flex h-24 w-full items-center justify-between border-t px-8">
            <a onClick={handleRedirectToInstagram} target="_blank" ref={instaRef} className={`p-[2px] rounded-md hover:cursor-pointer ${isHovered ? 'footer-insta' : ''}`}>
